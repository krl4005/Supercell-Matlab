...
function [ time, X, parameters ] = KL_SUPERmodelRunner( X0, options, parameters, beats, ignoreFirst)
...
% Extracellular concentrations- typically these are kept as constants! 
...
for n=1:beats
 ...
 % ADDED THIS IN TO CALCULATE GA error 
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    if n > beats/2
        %IKr_Multiplier = 1; this should be native potassium 
    %else 
        IKr_Multiplier = parameters.IKr_Multiplier-0.95; %IKr_Multiplier = 0.05;
    end 

%     if n > beats/2
%         %ICaL_Multiplier = 1; this should be native calcium 
%     %else 
%         ICaL_Multiplier = parameters.ICaL_Multiplier+7;
%     end 
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
